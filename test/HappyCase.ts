...
describe("", function () {
    ...
    describe("Deployment", function () {
        it("1", async function () {
            ...
            await campaign.launchCampaign(random32Bytes);
            expect(await campaign.currentCampaignId()).to.be.equal(1);
            ...
            await governor
                .connect(account)
                .castVote(proposalId, tokenIds[0], 0);
            await governor
                .connect(account)
                .castVote(proposalId, tokenIds[1], 1);
            await governor
                .connect(account)
                .castVote(proposalId, tokenIds[2], 2);
            await governor
                .connect(account)
                .castVote(proposalId, tokenIds[3], 2);
